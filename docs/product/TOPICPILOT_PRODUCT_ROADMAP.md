...
owner-accepted residual uncertainty. Core V0 research has completed the
bounded Selector V1 series and materialized its frozen research contract;
older A1/A2 evidence remains bounded research evidence, not strategy authority.
The latest Lifecycle-conditioned expectancy study is descriptive evidence with
bounded join coverage; it creates no strategy filter, score, threshold, OOS
claim, or policy promotion. No candidate has an accepted strategy, production
entry/stop, or recommendation publication.

The first evidence-backed individual-stock selection research contract,
Selector V1, is now frozen and its research series is closed. Its product
boundary is `Lifecycle V1.3 context → C5 working screen → S2 ranking → Top2`.
This is a research shortlist contract only; it is not a complete trading
strategy, live recommendation, portfolio, or production selector. Entry
timing, position sizing, risk regime, benchmark, execution, and transaction
costs remain separate contracts.
