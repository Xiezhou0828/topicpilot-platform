"""Explicit operator command for bundle-derived market calendar remediation."""
    ...
    try:
        ...
        try:
            with Session(engine, expire_on_commit=False) as session:
                result = remediate_market_calendar(
                    session, bundle, apply=args.apply, dry_run=args.dry_run
                )
