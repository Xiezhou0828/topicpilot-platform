"""Explicit operator command for transactional reference bootstrap/activation."""
    ...
    try:
        ...
        try:
            with Session(engine, expire_on_commit=False) as session:
                result = bootstrap_reference_bundle(
                    session,
                    bundle,
            ...
            engine.dispose()
    except (BundleValidationError, ReferenceBootstrapConflict, RuntimeError) as exc:
        print(
